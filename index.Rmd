...
```{r, echo = FALSE}
get_tidy_audio_analysis("0W4NhJhcqKCqEP2GIpDCDq") |>
...
Yellow indicating the bridge where the chords change because of a modulation 
...
hello <-
  play90s |>
  mutate(genre = "play90s") |>
  bind_rows(play10s |> mutate(genre = "play10s"))
```
